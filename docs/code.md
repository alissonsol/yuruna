...
| **Ubuntu Desktop** | `/automation/fetch-and-execute.sh guest/ubuntu.desktop/ubuntu.desktop.code.sh` |
| **Ubuntu Server** | `/automation/fetch-and-execute.sh guest/ubuntu.server/ubuntu.server.code.sh` |
| **Windows 11** | `irm "…/guest/windows.11/windows.11.code.ps1$nc" \| iex` (see [../guest/windows.11/README.md](../guest/windows.11/README.md)) |
