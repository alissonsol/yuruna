...
@{
    ...
    'status.draft_emails_cannot_automatically_include_attachments_so_please_m' = "Draft emails cannot automatically include attachments, so please`n      manually attach the downloaded file before you send it."
