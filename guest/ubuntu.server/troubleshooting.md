...
- `/automation/fetch-and-execute.sh guest/ubuntu.server/ubuntu.server.update.sh` (run two or three times until no updates or cleanup remain).
- `sudo reboot now`.
...
Back to [Ubuntu Server Guest - Workloads](README.md) · [Yuruna](../../README.md)
