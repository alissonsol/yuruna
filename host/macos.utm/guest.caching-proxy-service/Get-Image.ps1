...
# (enabled in host/vmconfig/caching-proxy-service.base.user-data) keeps pulling
...
# GB OS/logs/headroom -- see host/vmconfig/caching-proxy-service.base.user-data `cache_dir ufs
