<#PSScriptInfo
.VERSION 2026.07.22
.GUID 42a6c7d8-c9d0-4f12-3456-a7b8c9d0e1f6
...
# runs on Apple Silicon. Per the pool-control spec (default image
# ubuntu.server.26), matching the stash-service LTS so the VM stays in the
# supported-LTS window and the distro Go toolchain satisfies the daemon's
# go.mod directive.
