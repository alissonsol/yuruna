...
if ($NetworkMode -eq 'Shared') {
    Write-Output (Format-YurunaOperatorMessage -Key 'host.operator_6209dfd2fbe5b4e9' -Arguments @{ bridgeInterface = "$BridgeInterface" })
} else {
    Write-Output (Format-YurunaOperatorMessage -Key 'host.operator_92c535dbd0464f4c' -Arguments @{ bridgeInterface = "$BridgeInterface" })
}
...
# --- REGION: Guidance
Write-Output ""
Write-Output (Format-YurunaOperatorMessage -Key 'host.operator_0693526b7c911445')
...
Write-Output (Format-YurunaOperatorMessage -Key 'host.operator_36b65584ef16b478')
$guidance = @'
