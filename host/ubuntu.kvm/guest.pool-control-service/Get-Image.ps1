...
.DESCRIPTION
    ...
    ~/yuruna/image/pool-control-service/ as the base image for the pool-control-service
...
if (-not $IsLinux) {
    Write-Error "host/ubuntu.kvm/guest.pool-control-service/Get-Image.ps1 only runs on Linux."
    exit 1
}

# --- REGION: Configuration
# Ubuntu 26.04 LTS (Resolute Raccoon), per the pool-control-service spec
...
$baseImageName = "host.ubuntu.kvm.guest.pool-control-service"
