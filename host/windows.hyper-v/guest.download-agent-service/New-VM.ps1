...
# 8 GB RAM, 4 vCPU. Sized for the Go daemon streaming multi-GB artifacts between
# the origins and the pool share. Matches the stash-service VM profile so the
