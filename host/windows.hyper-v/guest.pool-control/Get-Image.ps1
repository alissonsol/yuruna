...
# (default image ubuntu.server.26) so the VM stays inside the supported-LTS
# window (matching the stash-service image) and the distro Go toolchain ships
# new enough to satisfy the daemon's go.mod directive without a toolchain fetch.
