...
From `yuruna\host\windows.hyper-v\guest.ubuntu.server.26` in
elevated PowerShell:
...
declared in
[test/sequences/gui/start.guest.ubuntu.server.26.yml](../../../test/sequences/gui/start.guest.ubuntu.server.26.yml)).
Initial password
