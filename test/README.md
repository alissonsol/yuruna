...
| `Test.Host` | Platform detection, elevation/accessibility/screen-lock checks, git | `Get-HostType`, `Get-GuestList`, `Assert-Elevation`, `Assert-ScreenLock`, `Assert-Accessibility`, `Set-MacHostConditions`, `Invoke-GitPull` |
