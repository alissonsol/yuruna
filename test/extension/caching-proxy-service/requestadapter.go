// Generated by tools/Invoke-CatalogEmbed.ps1 from globalization/kernel/yuruna.rawpage.js.
...
const requestAdapterScript = `// From globalization/kernel/yuruna.rawpage.js -- see that file for why.
(function (window) {
  'use strict';
