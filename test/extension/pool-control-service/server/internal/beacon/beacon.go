...
// Package beacon announces this service's presence to the pool-aggregator service so it
// appears in the Extension hosts table even without a host status-service probe.
