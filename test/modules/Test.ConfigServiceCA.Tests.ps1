...
<#
.SYNOPSIS
    Pester coverage for Test.ConfigServiceCA.psm1: the per-host Config CA mints a
...
Describe 'Test.ConfigServiceCA' {
    ...
    It 'issues a per-VM client leaf that validates as chaining to this host CA' {
        $client = New-YurunaConfigClientCertificate -SubjectName 'yuruna-caching-proxy-service' -HostId '42deadbeefdeadbeefdeadbeefdead01'
