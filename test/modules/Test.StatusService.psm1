...
.DESCRIPTION
    ...
    Note: the standalone Start-StatusService.ps1 script is preferred over
    this module function for production use.
#>
function Start-StatusService {
...
Export-ModuleMember -Function Start-StatusService, Stop-StatusService
