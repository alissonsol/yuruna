...
(function (root) {
  ...
  root.YurunaCatalogProvenance = {"version":"2026.09.08","hash":"cc8d2445c261ebc2b199f6537f722c79a06a08150fefa7ccaca61bd248929f1c"};
...
(function() {
  ...
  // ── Header helpers ──
  // --- REGION: https://yuruna.link/42fa6f45-001d
  ...
  function bootPerf() {
    ...
    function renderCycleRow(cyc, flame, pxPerMs, plotDepth, cycleLinks) {
      ...
      if (flame.fallback) {
        ...
        var ft = svgEl('title', {});
        // Both sentences come from the catalog, and the duration goes in as a
        // NUMBER: a caller that formatted its own would bake one locale's
        // shape into every locale's output.
        ft.textContent = t('status.step_timing_unavailable') + '\n' +
                         t('status.cycle_duration', { elapsed: flame.spanMs / 1000 });
        fr.appendChild(ft);
        svg.appendChild(fr);
        row.appendChild(svg);
        return row;
