...
This is the Windows Hyper-V counterpart of the [macOS UTM version](../../host.macos.utm/guest.ubuntu.desktop/). It uses [Hyper-V](https://learn.microsoft.com/en-us/virtualization/hyper-v-on-windows/) to run an Ubuntu Desktop VM on Windows.
...
Back to [[Ubuntu Desktop guest on Windows Hyper-V host](README.md)]
